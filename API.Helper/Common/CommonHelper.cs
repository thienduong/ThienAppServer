...
namespace API.Helper.Common
{
    ...
    public partial class CommonHelper
    {
        ...
        public static TypeConverter GetCustomTypeConverter(Type type)
        {
            ...
            {
                var enumListType = typeof(EnumListTypeConverter<>).MakeGenericType(type.GetGenericArguments()[0]);
                return Activator.CreateInstance(enumListType) as TypeConverter;
            }
